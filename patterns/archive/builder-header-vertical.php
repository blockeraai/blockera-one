...
?>
<!-- wp:columns {"isStackedOnMobile":false,"metadata":{"blockeraOne":"container/chrome-rail:vertical-rail"},"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"blockGap":{"left":"0"}}}} -->
<div class="wp-block-columns is-not-stacked-on-mobile" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
	...
	<div class="wp-block-column" style="flex-basis:8rem">
		<!-- wp:template-part {"slug":"vertical-header","area":"header","tagName":"header","metadata":{"blockeraOne":"section/header:vertical-header"}} /-->
	</div>
	<!-- /wp:column -->

	<!-- wp:column {"width":"90%","metadata":{"blockeraOne":"area/rail-body-area"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"default"}} -->
