...
?>
<!-- wp:group {"tagName":"main","metadata":{"blockeraOne":{"stamp":"layout/main:sidebar-left"}},"style":{"spacing":{"margin":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:33.33%">
			...
			<div class="wp-block-group">
				<!-- wp:template-part {"slug":"sidebar","theme":"blockera-one","metadata":{"blockeraOne":{"stamp":"section/sidebar"}}} /-->
			</div>
			<!-- /wp:group -->
		</div>
		<!-- /wp:column -->
