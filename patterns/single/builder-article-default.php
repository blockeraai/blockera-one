...
?>
<!-- wp:group {"tagName":"article","metadata":{"name":"Post","blockeraOne":{"stamp":"section/article:default"}},"layout":{"type":"constrained"}} -->
<article class="wp-block-group">
	<!-- wp:group {"metadata":{"name":"Media Blocks","blockeraOne":{"stamp":"container/media"}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-group">
		<!-- wp:post-featured-image {"aspectRatio":"3/2","metadata":{"blockeraOne":{"stamp":"section/post-featured-image:default"}}} /-->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group">
		...
		<!-- wp:group {"metadata":{"name":"Post Meta","blockeraOne":{"stamp":"section/post-meta:default","metaSeparator":"none"}},"blockeraId":"4hwuae","blockeraFlexChildSizing":{"value":"grow"},"blockeraWidth":{"value":"stretch"},"className":"blockera-block blockera-block-4hwuae","layout":{"type":"flex","flexWrap":"nowrap"}} -->
		<div class="wp-block-group blockera-block blockera-block-4hwuae">
			<!-- wp:group {"metadata":{"name":"Tags Meta","blockeraOne":{"stamp":"section/post-meta-tags:default"}},"style":{"spacing":{"blockGap":"0.35em"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
			<div class="wp-block-group">
				<!-- wp:post-terms {"term":"post_tag","separator":"  ","className":"is-style-post-terms-1","metadata":{"blockeraOne":{"stamp":"container/meta-item-block:default"}}} /-->
			</div>
			<!-- /wp:group -->
		</div>
		<!-- /wp:group -->
