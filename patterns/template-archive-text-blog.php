...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:query-title {"type":"archive","align":"wide","fontSize":"x-large","metadata":{"blockeraOne":"section/page-title-title:default"}} /-->
		<!-- wp:term-description {"align":"wide","metadata":{"blockeraOne":"section/page-title-description:default"}} /-->
	</div>
	<!-- /wp:group -->
