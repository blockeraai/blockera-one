...
<div class="wp-block-group blockera-block blockera-block-820192000002">
	<!-- wp:group {"metadata":{"name":"Author Name","blockeraOne":"section/post-meta-2-author-name:default"},"style":{"spacing":{"blockGap":"0.35em"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
	...
	<!-- /wp:paragraph -->
	<!-- wp:group {"metadata":{"name":"Published Date","blockeraOne":"section/post-meta-2-post-date:default"},"style":{"spacing":{"blockGap":"0.35em"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
	<div class="wp-block-group">
		<!-- wp:paragraph {"metadata":{"blockeraOne":"container/meta-item-prefix:default"}} -->
