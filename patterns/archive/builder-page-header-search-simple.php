...
<div class="wp-block-group alignwide blockera-block blockera-block-c7rjdy" style="margin-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group blockera-block blockera-block-8n21sf">
		<!-- wp:query-title {"type":"search","metadata":{"blockeraOne":"section/page-header-title:default"},"blockeraPropsId":"71513349183","blockeraCompatId":"71513349183","className":"blockera-block blockera-block-71513349183 is-style-default","style":{"color":[],"typography":[]}} /-->

		<!-- wp:search {"label":"<?php esc_html_e( 'Search', 'blockera-one' ); ?>","showLabel":false,"buttonText":"<?php esc_html_e( 'Search', 'blockera-one' ); ?>","metadata":{"blockeraOne":"section/page-header-search-form:default"},"blockeraPropsId":"71513349285","blockeraCompatId":"71513349285"} /-->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
