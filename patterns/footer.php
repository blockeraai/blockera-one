...
?>
<!-- wp:group {"metadata":{"blockeraOne":"layout/site-footer:default"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
