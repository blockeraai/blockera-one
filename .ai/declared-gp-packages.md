# Declared GP packages (blockera-one)
...
- On **blockera** / **blockera-one**, add a `*-pro` package to `package.json` or `composer.json` (those hosts must not npm/Composer-link Pro source).
