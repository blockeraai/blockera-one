...
<div class="wp-block-query alignwide">
	<!-- wp:post-template {"blockeraId":"0xzsvx","blockeraGap":{"value":{"lock":true,"gap":{"settings":{"id":"40","name":"Small","type":"spacing","reference":{"type":"theme","theme":"Blockera One"},"value":"30px","var":"--wp--preset--spacing--40"},"name":"Small","isValueAddon":true,"valueType":"variable"},"columns":"","rows":""}},"blockeraGridColumnCount":{"value":3},"className":"blockera-block blockera-block-0xzsvx","style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"grid","columnCount":3}} -->
		<!-- wp:group {"metadata":{"name":"Content Blocks","blockeraOne":{"stamp":"container/body"}},"blockeraId":"0l6p3f","blockeraDisplay":{"value":"flex"},"blockeraFlexLayout":{"value":{"direction":"column","alignItems":"stretch","justifyContent":"flex-start"}},"blockeraGap":{"value":{"lock":true,"gap":{"settings":{"id":"30","name":"X-Small","type":"spacing","reference":{"type":"theme","theme":"Blockera One"},"value":"20px","var":"--wp--preset--spacing--30"},"name":"X-Small","isValueAddon":true,"valueType":"variable"},"columns":"","rows":""}},"className":"blockera-block blockera-block-0l6p3f","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"top"}} -->
		<div class="wp-block-group blockera-block blockera-block-0l6p3f">
			<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"1","metadata":{"blockeraOne":{"stamp":"section/post-featured-image:default"}}} /-->

			<!-- wp:post-title {"isLink":true,"metadata":{"blockeraOne":{"stamp":"section/post-title:default"}},"blockeraId":"2a67vk","blockeraFontSize":{"value":{"settings":{"id":"medium","name":"Medium","type":"font-size","reference":{"type":"theme","theme":"Blockera One"},"value":"1rem","var":"--wp--preset--font-size--medium","fluid":{"max":"1.125rem","min":"1rem"}},"name":"Medium","isValueAddon":true,"valueType":"variable"}},"className":"blockera-block blockera-block-2a67vk","style":{"typography":[]},"fontSize":"medium"} /-->

			<!-- wp:group {"metadata":{"name":"Post Meta","blockeraOne":{"stamp":"section/post-meta:default","metaSeparator":"none"}},"blockeraId":"llfx63","blockeraFlexChildSizing":{"value":"grow"},"blockeraDisplay":{"value":"flex"},"blockeraFlexWrap":{"value":{"val":"nowrap","reverse":false}},"blockeraWidth":{"value":"stretch"},"blockeraFontSize":{"value":{"settings":{"id":"medium","name":"Medium","type":"font-size","reference":{"type":"theme","theme":"Blockera One"},"value":"1rem","var":"--wp--preset--font-size--medium","fluid":{"max":"1.125rem","min":"1rem"}},"name":"Medium","isValueAddon":true,"valueType":"variable"}},"className":"blockera-block blockera-block-llfx63","style":{"typography":[]},"fontSize":"medium","layout":{"type":"flex","flexWrap":"nowrap"}} -->
			<div class="wp-block-group blockera-block blockera-block-llfx63 has-medium-font-size">
	...
	<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
		<!-- wp:query-pagination {"paginationArrow":"arrow","metadata":{"blockeraOne":{"stamp":"section/pagination:standard"}},"blockeraId":"ls3ojm","blockeraFlexLayout":{"value":{"direction":"row","alignItems":"","justifyContent":"space-between"}},"align":"wide","className":"is-style-default blockera-block blockera-block-ls3ojm","layout":{"type":"flex","justifyContent":"space-between","orientation":"horizontal"}} -->
